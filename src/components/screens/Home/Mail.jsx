      ...
      <div className="container">
        <div className="mail__inner">
          <div className="mail__content">
            <div className="mail__contacts">
              <div className="mail__contacts-content" data-aos="zoom-in-up" data-aos-duration="1000">
                ...
                <h3 className="mail__contacts-text" id="mail-aos-anchor1">
            ...
            <div className="mail__form" id="mail">
              <h2 className="mail__form-title" data-aos="zoom-in-up" data-aos-duration="1000">
                Напишите нам
              </h2>
              <form
                onSubmit={handleSubmit(onSubmit)}
                className="mail__form-content"
                id="form"
                data-aos="zoom-in-up"
              ...
              >
                <input
                  ...
                  name="name"
                  className="mail__form-item _req name"
                  placeholder="Имя *"
                  {...register('name', {
                ...
                <input
                  ...
                  name="email"
                  className="mail__form-item _email _req email"
                ...
                <input
                  type="text"
                  id="et_pb_contact_tel_0"
                  className="mail__form-item _phone _req input phone"
                  name="phone"
                  placeholder="Телефон *"
                  {...register('phone', {
                    required: 'Поле обязательно к заполнению!',
                ...
                <textarea
                  ...
                  className="mail__form-item _req message"
                  cols="30"
                  rows="5"
                ...
                ></textarea>
                <input
                  className="mail__form-checkbox _req checkbox"
                  name="checkbox"
                  onChange={handleCheckChange}
                  checked={isChecked}
                  type="checkbox"
                  id="et_pb_contact_soglasie_4_0 checkbox"
                ...
                />
                <label className="mail__form-label" htmlFor="suggest">
                  даю согласие на обработку моих персональных данных
                </label>
                {errors?.checkbox && <p className="form-err-text">{errors?.checkbox?.message}</p>}
                <button className="mail__form-btn btn-error" type="submit" /*disabled={!isValid}*/>
                  отправить
                </button>
              </form>
            </div>
          ...
          <div className="mail__copyright">
            <h4>
              <Link to={'/terms-of-use'} className="mail__link">
                пользовательское соглашение
              </Link>
            </h4>
            <h4>
              <Link to={'/privacy-policy'} className="mail__link">
